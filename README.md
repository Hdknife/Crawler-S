...
Options are shown in the interface—select according to your requirements.
...
- **Gen AI API**: Visit Google’s Gemini AI API to get a free version. However, for large businesses, we recommend using the paid version for better performance. The API is a text string that you input into the Gen AI API option.
...
# Video Tutorial  
[🎥 Watch the Tutorial](https://github.com/user-attachments/assets/6b922b69-272f-4edd-9cdd-d7d9a3d56acc)
